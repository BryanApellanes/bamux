...
namespace Bam.Net.DaoRef
{
	...
	public partial class Right: Bam.Net.Data.Dao
	{
		public Right():base()
		{
	...
	public LeftRightCollection LeftRightsByRightId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<Right>> batchProcessor, Database database = null)
		{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchQuery<ColType>(int batchSize, QueryFilter filter, Action<IEnumerable<Right>> batchProcessor, Bam.Net.Data.OrderBy<RightColumns> orderBy, Database database = null)
		{
		...
		public static async Task BatchQuery<ColType>(int batchSize, WhereDelegate<RightColumns> where, Action<IEnumerable<Right>> batchProcessor, Bam.Net.Data.OrderBy<RightColumns> orderBy, Database database = null)
		{
			await System.Threading.Tasks.Task.Run(async ()=>
			{
				...
				while(results.Count > 0)
				{
					...
					results = Top(batchSize, (RightColumns)where(columns) && orderBy.Column > top, orderBy, database);
				}
			});
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<RightColumns> where, Database database = null)
		{
			SetOneWhere(where, out Right ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<RightColumns> where, out Right result, Database database = null)
		{
		...
		[Bam.Net.Exclude]
		public static RightCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
